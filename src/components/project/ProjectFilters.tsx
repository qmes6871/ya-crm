...
const statusOptions = [
  ...
  { value: "FIRST_DRAFT", label: "1차 시안 작업" },
  { value: "FIRST_DRAFT_REVIEW", label: "1차 시안 공개" },
  { value: "REVISION", label: "시안 수정" },
  { value: "FINAL_REVIEW", label: "시안 공개" },
];

export function ProjectFilters({ managers, clients }: ProjectFiltersProps) {
  ...
  return (
    <div className="bg-white border rounded-lg p-4 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        {/* 거래처 필터 */}
        <div className="space-y-2">
          <Label className="text-sm text-gray-600">거래처</Label>
          <Select
